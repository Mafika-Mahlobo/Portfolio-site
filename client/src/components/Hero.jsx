        ...
        <section id='home' ref={ref} className={`bg-linear-to-b from-gray-500 to-gray-800 text-gray-900 overflow-hidden justify-center p-0 m-0 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-90'}`}>
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-x-12 items-start min-h-fit p-5 m-0">
                <div className="flex flex-col items-stretch gap-y-5 p-5 m-0">
                    ...
                    <div className="container flex gap-x-4 justify-start">
                ...
                <div className="flex h-full w-full p-1 justify-center items-center">
                    <img src={profilePicture} alt="Profile" className="justify-self-center w-60 h-60  rounded-full object-cover bg-linear-to-b from-gray-800 to-gray-900 shadow-sm shadow-green-900" />

                </div>
            </div>
            <section className="flex justify-center bg-gray-600 p-4 shadow-5xl shadow-grey-900">
                <ul
                    className="flex flex-wrap justify-center gap-2 md:gap-10 max-w-4xl transition-all duration-700"
                >
                    {/** each skill is a fixed-size circle */}
                    <li
                        className="flex flex-col items-center justify-center w-20 h-20 sm:w-21 sm:h-21 rounded-full shadow-2xl shadow-gray-900 bg-linear-to-b from-gray-600 to-gray-800 text-gray-400 hover:animate-pulse">
                        <i className="fa-brands fa-js text-2xl"></i>
                        <span className="mt-1 text-xs sm:text-sm">JavaScript</span>
                    </li>
                    <li className="flex flex-col items-center justify-center w-20 h-20 sm:w-21 sm:h-21  rounded-full shadow-2xl shadow-gray-900 bg-linear-to-b from-gray-600 to-gray-800 text-gray-400 hover:animate-pulse">
