  ...
  return (
    <section className='bg-linear-to-br from-gray-800 to-gray-700 p-10'>
        <div className='grid grid-cols-1 md:grid-cols-2 border border-gray-500 rounded-2xl shadow-2xl shadow-gray-900 p-10'>
            ...
            <div className='rounded-tr-2xl rounded-br-2xl shadow-2xl shadow-gray-900 flex justify-center align-middle p-10'>
                <form className='text-gray-300 flex flex-col p-2 md:p-0 gap-4 w-fit'>
                    ...
                    <div className='w-full flex justify-center md:justify-start'>
                      <button className='bg-green-700 text-white px-6 py-2 rounded-2xl m-0 w-full hover:bg-green-800 transition-colors'>Leave a message</button>
                    </div>
                </form>
            </div>
        </div>
